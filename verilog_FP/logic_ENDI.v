...
RAM_func #(.ADDRS_WIDTH(6), .DATA_WIDTH(68))
    ...
    .wren       (wrenq    ),
    .wraddrs    (wraddrsq ),
    .wrdata     ({Cin, Vin, n_flag, z_flag, ENDI}),
    .rdenA      (rdenA    ),
    .rdaddrsA   (rdaddrsA ),
    .rddataA    (rddataA  ),
    .rdenB      (rdenB    ),
...
always @(*)
    if (wrenq) 
        case(ENDI_SEL)
           4'b0101 : ENDI <= {48'h0000_0000_0000, oprndA[7:0], oprndA[15:8]};  //upper and lower bytes of single half-word (16 bits)
           4'b1001 : ENDI <= {32'h0000_0000, oprndB[7:0], oprndB[15:8], oprndA[7:0], oprndA[15:8]}; 
           4'b1010 : ENDI <= {32'h0000_0000, oprndA[7:0], oprndA[15:8], oprndA[23:16], oprndA[31:24]};
           4'b1101 : ENDI <= {32'h0000_0000, oprndB[7:0], oprndB[15:8], oprndA[7:0], oprndA[15:8]}; 
           4'b1110 : ENDI <= {oprndB[7:0], oprndB[15:8], oprndB[23:16], oprndB[31:24]   ,oprndA[7:0], oprndA[15:8],  oprndA[23:16], oprndA[31:24]};
           4'b1111 : ENDI <= {oprndA[7:0], oprndA[15:8], oprndA[23:16], oprndA[31:24], oprndA[39:32], oprndA[47:40], oprndA[55:48], oprndA[63:56]};
